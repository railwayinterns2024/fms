        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../SignUP-SignIn-FIrebase-main/railwayimg.jpg">
                <div class="sidebar-brand-icon ">
                    <img src="../SignUP-SignIn-FIrebase-main/logo cropped.png" alt="Login Image" class="img-fluid custom-bg-image">
                </div>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../SignUP-SignIn-FIrebase-main/index.php">
