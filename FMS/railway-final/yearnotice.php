        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="grid-container hidden" id="year-grid">
                    <a href="yearss.php" class="grid-item">2020</a>
                    <a href="yearss.php" class="grid-item">2021</a>
                    <a href="yearss.php" class="grid-item">2022</a>
                    <a href="yearss.php" class="grid-item">2023</a>
                    <a href="yearn.php" class="grid-item">2024</a>
                    <a href="yearss.php" class="grid-item">2025</a>
