    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item dropdown active">
                <a class="nav-link dropdown-toggle" href="#" id="railwayDashboardDropdown" role="button"
                ...
                <div class="dropdown-menu" aria-labelledby="railwayDashboardDropdown">
                    ...
                    <a class="dropdown-item dropdown-toggle" href="#" id="category2Dropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Policy
                    </a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="grid-container hidden" id="year-grid">
                    <a href="#" class="grid-item">2020</a>
                    <a href="#" class="grid-item">2021</a>
                    <a href="#" class="grid-item">2022</a>
                    <a href="#" class="grid-item">2023</a>
                    <a href="yearss.php" class="grid-item">2024</a>
                    <a href="#" class="grid-item">2025</a>
